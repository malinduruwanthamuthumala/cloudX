...
<div class="well col-md-4 col-md-offset-4 box ">
	<form action="datajob.php" method="post">
		...
		<input type="text" name="description" id="description" placeholder="description" class="form-control"><br>
		
		<label for="if">job field</label>
